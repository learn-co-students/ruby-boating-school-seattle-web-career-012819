...
coding = jessica.add_boating_test("Coding 101", "failed", steve)
perct = jessica.add_boating_test("Testing percent", "passed", steve)
...
puts "Testing find student here" 
puts Student.find_student(jessica)
...
Student.find_student(chelsea)
tire_change = BoatingTest.new(bob, "Tire Change", 'passed', teacher_woman)

puts jessica.grade_percentage 
